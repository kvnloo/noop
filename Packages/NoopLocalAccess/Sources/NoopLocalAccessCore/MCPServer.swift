    ...
    .object([
        "tools": .array([
            ...
            tool(
                ...
                description: "Report local NOOP source freshness, storage counts, available metric keys, and latest timestamps for heart-rate, RR interval, event, and sleep session samples. Missing tables are null.",
                properties: [:]
            ),
            tool(
                name: "sleep_summary",
